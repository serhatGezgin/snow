...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getFeaturesFeatureParserRuleCall_0_0_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getFeaturesFeatureParserRuleCall_0_1_0()); 
	    }
...
(
	...
	otherlv_3='group id' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getModuleAccess().getGroupIdKeyword_3());
    }
(
(
		lv_groupId_4_0=RULE_STRING
		{
			newLeafNode(lv_groupId_4_0, grammarAccess.getModuleAccess().getGroupIdSTRINGTerminalRuleCall_4_0()); 
		}
		{
	        if ($current==null) {
...
)	otherlv_5='artifact id' 
    {
    	newLeafNode(otherlv_5, grammarAccess.getModuleAccess().getArtifactIdKeyword_5());
    }
(
(
		lv_artifactId_6_0=RULE_STRING
		{
			newLeafNode(lv_artifactId_6_0, grammarAccess.getModuleAccess().getArtifactIdSTRINGTerminalRuleCall_6_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getModuleRule());
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getModuleAccess().getVersionKeyword_7());
    }
(
(
		lv_version_8_0=RULE_STRING
		{
			newLeafNode(lv_version_8_0, grammarAccess.getModuleAccess().getVersionSTRINGTerminalRuleCall_8_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getModuleRule());
		...
		(
			...
			( 
				{getUnorderedGroupHelper().canSelect(grammarAccess.getModuleAccess().getUnorderedGroup_9(), 0)}?=>(
					...
					({true}?=>(	otherlv_10='jdbc' 
    {
    	newLeafNode(otherlv_10, grammarAccess.getModuleAccess().getJdbcKeyword_9_0_0());
    }
(
(
		{
		...
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getJdbcJdbcCrossReference_9_0_1_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
			...
			( 
				{getUnorderedGroupHelper().canSelect(grammarAccess.getModuleAccess().getUnorderedGroup_9(), 1)}?=>(
					...
					({true}?=>(	otherlv_12='connector' 
    {
    	newLeafNode(otherlv_12, grammarAccess.getModuleAccess().getConnectorKeyword_9_1_0());
    }
(
(
		{
		...
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getConnectorDBConnectorDependencyCrossReference_9_1_1_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
...
)	otherlv_14='domain model' 
    {
    	newLeafNode(otherlv_14, grammarAccess.getModuleAccess().getDomainModelKeyword_10());
    }
(
(
		{
		...
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getDomainModelDomainModelCrossReference_11_0()); 
	    }
		ruleQualifiedName		{ 
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_16, grammarAccess.getModuleAccess().getRightCurlyBracketKeyword_12());
    }
)
;
...
(
    { 
        newCompositeNode(grammarAccess.getFeatureAccess().getJdbcParserRuleCall_0()); 
    }
    this_Jdbc_0=ruleJdbc
    { 
        $current = $this_Jdbc_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getFeatureAccess().getDBConnectorDependencyParserRuleCall_1()); 
    }
    this_DBConnectorDependency_1=ruleDBConnectorDependency
    { 
        $current = $this_DBConnectorDependency_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleDBConnectorDependency returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDBConnectorDependencyRule()); }
	 iv_ruleDBConnectorDependency=ruleDBConnectorDependency 
	 { $current=$iv_ruleDBConnectorDependency.current; } 
	 EOF 
;

// Rule DBConnectorDependency
ruleDBConnectorDependency returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='connector' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getDBConnectorDependencyAccess().getConnectorKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getDBConnectorDependencyAccess().getNameQualifiedNameParserRuleCall_1_0()); 
	    }
		lv_name_1_0=ruleQualifiedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getDBConnectorDependencyRule());
	        }
       		set(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getDBConnectorDependencyAccess().getLeftCurlyBracketKeyword_2());
    }
	otherlv_3='group id' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getDBConnectorDependencyAccess().getGroupIdKeyword_3());
    }
(
(
		lv_groupId_4_0=RULE_STRING
		{
			newLeafNode(lv_groupId_4_0, grammarAccess.getDBConnectorDependencyAccess().getGroupIdSTRINGTerminalRuleCall_4_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getDBConnectorDependencyRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"groupId",
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getDBConnectorDependencyAccess().getArtifactIdKeyword_5());
    }
(
(
		lv_artifactId_6_0=RULE_STRING
		{
			newLeafNode(lv_artifactId_6_0, grammarAccess.getDBConnectorDependencyAccess().getArtifactIdSTRINGTerminalRuleCall_6_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getDBConnectorDependencyRule());
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getDBConnectorDependencyAccess().getVersionKeyword_7());
    }
(
(
		lv_version_8_0=RULE_STRING
		{
			newLeafNode(lv_version_8_0, grammarAccess.getDBConnectorDependencyAccess().getVersionSTRINGTerminalRuleCall_8_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getDBConnectorDependencyRule());
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getDBConnectorDependencyAccess().getRightCurlyBracketKeyword_9());
    }
)
;
...
entryRuleJdbc returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getJdbcRule()); }
	 iv_ruleJdbc=ruleJdbc 
	 { $current=$iv_ruleJdbc.current; } 
	 EOF 
;

// Rule Jdbc
ruleJdbc returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='jdbc' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getJdbcAccess().getJdbcKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getJdbcAccess().getNameQualifiedNameParserRuleCall_1_0()); 
	    }
		lv_name_1_0=ruleQualifiedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getJdbcRule());
	        }
       		set(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getJdbcAccess().getLeftCurlyBracketKeyword_2());
    }
	otherlv_3='user' 
    {
    	newLeafNode(otherlv_3, grammarAccess.getJdbcAccess().getUserKeyword_3());
    }
(
(
		lv_user_4_0=RULE_STRING
		{
			newLeafNode(lv_user_4_0, grammarAccess.getJdbcAccess().getUserSTRINGTerminalRuleCall_4_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getJdbcRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"user",
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getJdbcAccess().getPasswordKeyword_5());
    }
(
(
		lv_password_6_0=RULE_STRING
		{
			newLeafNode(lv_password_6_0, grammarAccess.getJdbcAccess().getPasswordSTRINGTerminalRuleCall_6_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getJdbcRule());
    ...
    {
    	newLeafNode(otherlv_7, grammarAccess.getJdbcAccess().getUrlKeyword_7());
    }
(
(
		lv_url_8_0=RULE_STRING
		{
			newLeafNode(lv_url_8_0, grammarAccess.getJdbcAccess().getUrlSTRINGTerminalRuleCall_8_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getJdbcRule());
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getJdbcAccess().getDriverKeyword_9());
    }
(
(
		lv_driver_10_0=RULE_STRING
		{
			newLeafNode(lv_driver_10_0, grammarAccess.getJdbcAccess().getDriverSTRINGTerminalRuleCall_10_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getJdbcRule());
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getJdbcAccess().getRightCurlyBracketKeyword_11());
    }
)
;
