 ...
 * generated by Xtext
 */
package org.yazgel.snow.notation.text.ui.contentassist.antlr;
...
public class ModuleParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.yazgel.snow.notation.text.ui.contentassist.antlr.internal.InternalModuleParser createParser() {
		org.yazgel.snow.notation.text.ui.contentassist.antlr.internal.InternalModuleParser result = new org.yazgel.snow.notation.text.ui.contentassist.antlr.internal.InternalModuleParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleAccess().getGroup_9_0(), "rule__Module__Group_9_0__0");
					put(grammarAccess.getModuleAccess().getGroup_9_1(), "rule__Module__Group_9_1__0");
					put(grammarAccess.getDBConnectorDependencyAccess().getGroup(), "rule__DBConnectorDependency__Group__0");
					put(grammarAccess.getJdbcAccess().getGroup(), "rule__Jdbc__Group__0");
					...
					put(grammarAccess.getModelAccess().getFeaturesAssignment_0_0(), "rule__Model__FeaturesAssignment_0_0");
					put(grammarAccess.getModelAccess().getFeaturesAssignment_0_1(), "rule__Model__FeaturesAssignment_0_1");
					...
					put(grammarAccess.getModuleAccess().getGroupIdAssignment_4(), "rule__Module__GroupIdAssignment_4");
					put(grammarAccess.getModuleAccess().getArtifactIdAssignment_6(), "rule__Module__ArtifactIdAssignment_6");
					put(grammarAccess.getModuleAccess().getVersionAssignment_8(), "rule__Module__VersionAssignment_8");
					put(grammarAccess.getModuleAccess().getJdbcAssignment_9_0_1(), "rule__Module__JdbcAssignment_9_0_1");
					put(grammarAccess.getModuleAccess().getConnectorAssignment_9_1_1(), "rule__Module__ConnectorAssignment_9_1_1");
					put(grammarAccess.getModuleAccess().getDomainModelAssignment_11(), "rule__Module__DomainModelAssignment_11");
					put(grammarAccess.getDBConnectorDependencyAccess().getNameAssignment_1(), "rule__DBConnectorDependency__NameAssignment_1");
					put(grammarAccess.getDBConnectorDependencyAccess().getGroupIdAssignment_4(), "rule__DBConnectorDependency__GroupIdAssignment_4");
					put(grammarAccess.getDBConnectorDependencyAccess().getArtifactIdAssignment_6(), "rule__DBConnectorDependency__ArtifactIdAssignment_6");
					put(grammarAccess.getDBConnectorDependencyAccess().getVersionAssignment_8(), "rule__DBConnectorDependency__VersionAssignment_8");
					put(grammarAccess.getJdbcAccess().getNameAssignment_1(), "rule__Jdbc__NameAssignment_1");
					put(grammarAccess.getJdbcAccess().getUserAssignment_4(), "rule__Jdbc__UserAssignment_4");
					put(grammarAccess.getJdbcAccess().getPasswordAssignment_6(), "rule__Jdbc__PasswordAssignment_6");
					put(grammarAccess.getJdbcAccess().getUrlAssignment_8(), "rule__Jdbc__UrlAssignment_8");
					put(grammarAccess.getJdbcAccess().getDriverAssignment_10(), "rule__Jdbc__DriverAssignment_10");
					...
					put(grammarAccess.getModuleAccess().getUnorderedGroup_9(), "rule__Module__UnorderedGroup_9");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.yazgel.snow.notation.text.ui.contentassist.antlr.internal.InternalModuleParser typedParser = (org.yazgel.snow.notation.text.ui.contentassist.antlr.internal.InternalModuleParser) parser;
