...
public class SnowPackageImpl extends EPackageImpl implements SnowPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPersistenceModel_JdbcDriver(), ecorePackage.getEString(), "jdbcDriver", "org.postgresql.Driver", 0, 1, PersistenceModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPersistenceModel_JdbcUrl(), ecorePackage.getEString(), "jdbcUrl", "", 0, 1, PersistenceModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPersistenceModel_DbConnectorDependency(), ecorePackage.getEString(), "dbConnectorDependency", "<dependency><groupId>org.postgresql</groupId><artifactId>postgresql</artifactId><version>9.4-1201-jdbc41</version></dependency>", 0, 1, PersistenceModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
