...
public abstract class AbstractSnowRuntimeModule extends org.eclipse.xtext.xbase.DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/yazgel/snow/notation/text/Snow.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.yazgel.snow.notation.text.Snow");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("snw");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.yazgel.snow.notation.text.services.SnowGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.yazgel.snow.notation.text.serializer.SnowSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.yazgel.snow.notation.text.serializer.SnowSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.yazgel.snow.notation.text.parser.antlr.SnowParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.yazgel.snow.notation.text.parser.antlr.SnowAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.yazgel.snow.notation.text.parser.antlr.internal.InternalSnowLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.yazgel.snow.notation.text.parser.antlr.internal.InternalSnowLexer> provideInternalSnowLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.yazgel.snow.notation.text.parser.antlr.internal.InternalSnowLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.yazgel.snow.notation.text.parser.antlr.internal.InternalSnowLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.yazgel.snow.notation.text.formatting.SnowFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.yazgel.snow.notation.text.jvmmodel.SnowJvmModelInferrer.class;
	}
