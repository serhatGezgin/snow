 ...
 * <ul>
 *   <li>{@link org.yazgel.snow.notation.text.snow.impl.AbstractElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractElementImpl extends MinimalEObjectImpl.Container implements AbstractElement
{
  ...
  {
    return SnowPackage.Literals.ABSTRACT_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SnowPackage.ABSTRACT_ELEMENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SnowPackage.ABSTRACT_ELEMENT__NAME:
        return getName();
    }
