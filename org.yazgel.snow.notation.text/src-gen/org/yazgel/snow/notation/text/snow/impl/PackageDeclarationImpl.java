 ...
 * <ul>
 *   <li>{@link org.yazgel.snow.notation.text.snow.impl.PackageDeclarationImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageDeclarationImpl extends AbstractElementImpl implements PackageDeclaration
{
  ...
  {
    return SnowPackage.Literals.PACKAGE_DECLARATION;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, SnowPackage.PACKAGE_DECLARATION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SnowPackage.PACKAGE_DECLARATION__ELEMENTS:
